...
// these are from https://www.w3schools.com/java/java_files_create.asp
...
public void setup()
{
    ...
    //start of my code from https://www.w3schools.com/java/java_files_create.asp 
    try {
  ...
  //end of my code from https://www.w3schools.com/java/java_files_create.asp
}
...
try {
      FileWriter myWriter = new FileWriter("filename.txt", true); //https://stackoverflow.com/questions/18194575/how-can-i-write-java-output-in-text-file-continuously
      
      // serial message is in format:
//{"t":1323,"ng":1,"lu":0,"g":[{"t":"Current AMP Graph","xvy":0,"pd":1500,"sz":3,"l":["AMPs","Max","Min"],"c":["green","orange","cyan"],"d":[0.04615443,10.00000000,0.00000000]}]}#
      // we care about the first number after "d":[
      
      String message_copy = message;
      String[] arrOfStr = message_copy.split("d", 2);
      String message_part = arrOfStr[1];
      
      String[] arrOfStr2 = message_part.split(",", 2);
      String message_part2 = arrOfStr2[0];
      
      //tying to split at the "[" somehow causes the program to be unable to find the serial port no clue what is happening
      //String[] arrOfStr3 = message_part2.split("[", 2);
      String[] arrOfStr3 = message_part2.split(":", 2);
      String message_part3 = arrOfStr3[1];
      
      String message_part4 = message_part3.substring(1);
        
      String super_message = message_part4 + ",";
      myWriter.write(super_message);
